...
- ✅ **Phase 3 — 待验证 metrics (完成)**：ZCR ✅、MPT/VoicingRatio/DUV ✅、VibratoJitter ✅、cPhon ✅（Phase 2 已验）、**GNE ✅**。GNE 原是带对称比、与真 GNE 反相关 r=−0.98；用户解冻后已**换成原生 Michaelis GNE**（与 SNR 正相关 +0.94、与 Praat +0.59），转 PASS（metrics/gne.md）。全 5 组 PASS。
