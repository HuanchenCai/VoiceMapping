...
# cli.py now lives inside voicemap/, so absolute "from voicemap.X import Y"
# works once the project root is on sys.path (the root main.py shim does that).
...
def main():
    ...
    if args.compare:
        ...
        from voicemap.plotter import save_vrp_comparison
    ...
    # Single-file mode
    from voicemap.config import DEFAULT_CONFIG
